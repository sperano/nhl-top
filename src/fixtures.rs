...
use nhl_api::{
    GameDate,
    Boxscore, BoxscoreTeam, ClubStats, DailySchedule, Franchise,
    GameMatchup, GameState, PlayerLanding, Standing, ScheduleGame, ScheduleTeam,
    PeriodDescriptor, GameClock, GameSummary,
...
fn create_game_matchup_final(overtime: bool) -> GameMatchup {
    ...
    GameMatchup {
        ...
        period_descriptor: nhl_api::PeriodDescriptor {
            ...
            period_type: if overtime { "OT" } else { "REG" }.to_string(),
            max_regulation_periods: 3,
        },
        tv_broadcasts: vec![],
