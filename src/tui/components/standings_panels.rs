...
/// Props for standings panel components
#[derive(Clone)]
...
/// League standings panel - single column with all teams sorted by points
pub struct LeagueStandingsPanel;
...
/// Conference standings panel - two columns (Eastern/Western)
pub struct ConferenceStandingsPanel;

impl ConferenceStandingsPanel {
    pub fn render(props: &StandingsPanelProps) -> Element {
        // Group standings by conference
        let mut grouped: BTreeMap<String, Vec<Standing>> = BTreeMap::new();
        for standing in &props.standings {
        ...
        if groups.len() == 2 && props.config.display_standings_western_first {
            groups.reverse();
        }

        // If we don't have exactly 2 conferences, fall back to league view
        if groups.len() != 2 {
            return LeagueStandingsPanel::render(props);
        }
...
// ============================================================================
// Division Standings Panel
// ============================================================================

/// Division standings panel - two columns of divisions
pub struct DivisionStandingsPanel;

impl DivisionStandingsPanel {
    pub fn render(props: &StandingsPanelProps) -> Element {
...
// ============================================================================
// Wildcard Standings Panel
// ============================================================================

/// Wildcard standings panel - playoff format with division leaders and wildcards
pub struct WildcardStandingsPanel;

impl WildcardStandingsPanel {
    pub fn render(props: &StandingsPanelProps) -> Element {
    ...
    fn create_wildcard_column_layout(elements: Vec<Element>) -> Element {
        ...
        match elements.len() {
            ...
            _ => vertical([Constraint::Min(0)], elements),
        }
    }
}
...
mod tests {
    ...
    #[test]
    fn test_league_panel_renders_all_teams() {
    ...
    // ========================================================================
    // Conference Panel Tests
    // ========================================================================

    #[test]
    fn test_conference_panel_renders_two_columns() {
        let props = create_test_props();
    ...
    #[test]
    fn test_conference_panel_western_first() {
        let mut props = create_test_props();
        props.config.display_standings_western_first = true;
        ...
        assert_buffer(&buf, &[
            ...
            "  Team                        GP    W     L    OT   PTS       Team                        GP    W     L    OT   PTS",
            "  ───────────────────────────────────────────────────────     ───────────────────────────────────────────────────────",
            "  Avalanche                     19    16    2    1     33     Panthers                      19    14    3    2     30",
            "  Stars                         20    14    4    2     30     Bruins                        18    13    4    1     27",
            "  Jets                          19    13    5    1     27     Maple Leafs                   19    12    5    2     26",
            "  Wild                          19    11    6    2     24     Lightning                     18    11    6    1     23",
            "  Predators                     19    10    7    2     22     Canadiens                     18    10    5    3     23",
            "  Blues                         19     8    8    3     19     Senators                      18     9    7    2     20",
            "  Blackhawks                    18     7   10    1     15     Red Wings                     18     8    8    2     18",
            "  Coyotes                       18     4   13    1      9     Sabres                        18     6   10    2     14",
            "  Golden Knights                19    15    3    1     31     Devils                        18    15    2    1     31",
            "  Oilers                        20    14    4    2     30     Hurricanes                    19    14    3    2     30",
            "  Kings                         19    12    6    1     25     Rangers                       18    12    5    1     25",
            "  Kraken                        19    11    6    2     24     Penguins                      19    11    6    2     24",
            "  Canucks                       19    10    7    2     22     Capitals                      18    10    7    1     21",
            "  Flames                        19     9    8    2     20     Islanders                     18     9    7    2     20",
            "  Ducks                         19     7   10    2     16     Flyers                        18     8    9    1     17",
            "  Sharks                        18     5   12    1     11     Blue Jackets                  18     5   11    2     12",
            "",
            "",
            "",
            "",
    ...
    // ========================================================================
    // Division Panel Tests
    // ========================================================================

    #[test]
    fn test_division_panel_renders_four_divisions() {
        let props = create_test_props();
        let element = DivisionStandingsPanel::render(&props);
        let config = DisplayConfig::default();
        let buf = render_element_to_buffer(&element, RENDER_WIDTH, RENDER_HEIGHT, &config);
    ...
    // ========================================================================
    // Wildcard Panel Tests
    // ========================================================================

    #[test]
    fn test_wildcard_panel_renders_playoff_format() {
        let props = create_test_props();
        let element = WildcardStandingsPanel::render(&props);
        let config = DisplayConfig::default();
        let buf = render_element_to_buffer(&element, RENDER_WIDTH, RENDER_HEIGHT, &config);
